...
var canvasArray = [
	document.getElementById('Tv1'),
    // document.getElementById('viz2'),
    // document.getElementById('viz3'),
    // document.getElementById('viz4'),
    // document.getElementById('viz5'),
    // document.getElementById('viz6'),
    // document.getElementById('viz7'),
    // document.getElementById('viz8'),
    // document.getElementById('viz9'),
    // document.getElementById('viz10'),
    // document.getElementById('viz11'),
    // document.getElementById('viz12')
]
		//EVENT HANDLERS
		...
		// $(canvasArray).append(renderer.domElement);
	...
	function onResize(){
		...
		if (ControlsHandler.vizParams.fullSize){
			...
			$('#Tv1').css({top:window.innerHeight/2 - FIXED_SIZE_H/2});
		}
